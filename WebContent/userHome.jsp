<%@page errorPage="error.jsp" %>
    <%@ include file="Database.jsp" %>
        ...
        <body>
            <div class="container">
                <!-- Added Registered Events button -->
                <div class="row">
            <div class="col-md-12">
                <a href="Temp.jsp" class="btn btn-primary mt-2">Registered Events</a>
            </div>
        </div> 
                <h2 align=center>Welcome to user home</h2>
                <div class="img">
                    <img src="./images/Event.jpg" class='img-fluid w-100' style="height:800px;">
                </div>
                <div class="row">
                    ...
                    rs=ps.executeQuery(); while (rs.next()) { %>
                        ...
                        <div class="col-lg-4 col-md-6 my-2">
                            <div class="card h-100" style="width: 22rem;">
                                ...
                                <div class="card-body">
                                    <a class="btn btn-danger btn-sm" href="Register.jsp?serialNo=<%= rs.getString("serialNo") %>">Register</a>
